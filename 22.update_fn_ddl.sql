/*
Usage : psql -d {DBNAME} -f 22.update_fn_ddl.sql > /home/gpadmin/gpconfigs/fn20230808/{DBNAME}/22.update_fn_ddl.{DBNAME}.sh
*/

SELECT 'echo ";" >> ' || :val || '/' || org.dbname || '/' || org.nspname || org.proname || '_' || array_to_string(org.arg_val,',')
FROM
	(SELECT st.dbname
	, st.nspname
	, st.proname
